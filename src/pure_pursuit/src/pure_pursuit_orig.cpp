...
//   ackermann_msgs::AckermannDrive cmd_acker_;
...
//    cmd_acker_.steering_angle_velocity = delta_vel_;
//    cmd_acker_.acceleration = acc_;
//    cmd_acker_.jerk = jerk_;
...
//   pub_acker_ = nh_.advertise<ackermann_msgs::AckermannDrive>("cmd_acker", 1);
...
//    cmd_acker_.steering_angle = std::min( atan2(2 * yt * L_, ld_2), delta_max_ );
...
//        cmd_acker_.steering_angle = 0.0;
//        cmd_acker_.speed = 0.0;
    }
