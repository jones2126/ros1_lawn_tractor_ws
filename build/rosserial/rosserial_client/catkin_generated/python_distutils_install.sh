...
echo_and_run cd "/home/tractor/ros1_lawn_tractor_ws/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/home/tractor/ros1_lawn_tractor_ws/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/tractor/ros1_lawn_tractor_ws/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
