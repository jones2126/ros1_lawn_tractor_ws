...
echo_and_run cd "/home/tractor/ros1_lawn_tractor_ws/src/geonav_transform"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/tractor/ros1_lawn_tractor_ws/src/geonav_transform/setup.py" \
     \
    build --build-base "/home/tractor/ros1_lawn_tractor_ws/build/geonav_transform" \
    install \
    --root="${DESTDIR-/}" \
