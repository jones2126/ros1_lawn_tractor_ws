...
$ python3 /home/tractor/ros1_lawn_tractor_ws/project_notes/code_for_testing/path_pp_sakai_v2.py
...
def main():
    ...
    cx = mission_list_x_coordinates
    cy = mission_list_y_coordinates
