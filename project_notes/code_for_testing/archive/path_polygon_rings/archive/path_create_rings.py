...
$ python3 /home/tractor/ros1_lawn_tractor_ws/project_notes/code_for_testing/archive/path_polygon_rings/path_create_rings.py
...
def create_inner_rings(gps_data, num_inner_rings, path_size, start_point, xy_file_name):
    ...
    # Main processing of the function
    polygon_points = list(zip(gps_data['pose_x'], gps_data['pose_y']))
    ...
    paths.append(reorder_ring(ensure_clockwise(polygon_points), start_point))
