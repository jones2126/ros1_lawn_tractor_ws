...
'''
Script to understand the indexing in the spreadsheet.

$ python3 /home/tractor/ros1_lawn_tractor_ws/project_notes/code_for_testing/archive/path_polygon_rings/test_reading_innerpath2.py
'''
print("Running test_reading_innerpath2.py")
