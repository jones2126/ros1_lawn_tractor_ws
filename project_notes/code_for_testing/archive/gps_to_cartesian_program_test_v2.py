#!/usr/bin/env python3  
# python3 /home/tractor/ros1_lawn_tractor_ws/project_notes/code_for_testing/archive/gps_to_cartesian_program_test_v2.py
import math
...
# now read in lat, lon points from a .json file
...
#origin_lat, origin_lon = gps_points['Point 1 (Origin)']
#new_origin_lat, new_origin_lon
