#!/usr/bin/env python3
'''
The script is designed to read .csv file defined in the locations database to get x, y points and display the polygon from those points
...
def main():
    ...
    # read a CSV file and build a list of points from the specified x and y columns which will be returned as a list of tuples
