...
#python3 /home/tractor/ros1_lawn_tractor_ws/project_notes/code_for_testing/archive/path_boustrophedon_coverage_v7_simple_overlay.py
...
# Plotting
def plot_polygon_with_lines(polygon, trimmed_lines, centroid, angle):
...
# Generate and trim lines with a 75 degree angle
angle = 45  # or whatever angle you're using
trimmed_lines, polygon, centroid = generate_and_trim_lines(polygon_points, separation=0.9, angle)
