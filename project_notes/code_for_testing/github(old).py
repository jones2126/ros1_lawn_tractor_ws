...
class Steps_to_Process(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        step_1_button = ttk.Button(self, text="1. Push updates for ros1_lawn_tractor_ws", width=50, command=self.step_1_actions)
        step_2_button = ttk.Button(self, text="2. blank", width=50, command=self.step_2_actions)
        step_3_button = ttk.Button(self, text="3. blank", width=50, command=self.step_3_actions)
        step_4_button = ttk.Button(self, text="blank", width=50, command=self.step_4_actions)
        step_5_button = ttk.Button(self, text="blank", width=50, command=self.step_5_actions)
        step_6_button = ttk.Button(self, text="blank", width=50, command=self.step_6_actions)        
    ...
    def step_1_actions(self): # launch Gazebo
        ...
        time.sleep(3)
        github_token="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"
